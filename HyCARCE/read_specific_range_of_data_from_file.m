function [origData origLabel] = read_specific_range_of_data_from_file(filename,nooffeatures,startRecNo, endRecNo)
...
if (endRecNo <= 0 || endRecNo <= startRecNo)
     error(['endRecNo shoud be positive and greater than start rec no.']);
end;
%      %else
